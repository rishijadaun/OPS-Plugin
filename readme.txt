...
Tags: On Page SEO, OPS, SEO,canonical, Keyword Search, Yoast, Keyword Rank, Robots.txt,  XML Sitemap, All In One SEO, crawler, robot, robots, search engines
...
* If you need any help see [Plugin Website](https://plugins.wordpress.org/ops-robots.txt).

== Installation ==

 1. Install On page SEO Robots.txt either via the WordPress.org plugin directory, or by uploading the files to your server
 2. Enable the plugin by clicking activate button.
 3. Activate the plugin through the 'Plugins' menu in WordPress.
 4. Go to the On Page SEO and set your options.
...
You can edit this settings on **Dashboard >> On Page SEO Plugin >> Robots.txt File** options directly.

= I am already using Yoest Plugin , It will conflict?=
No, It is already tested with Yoest plugin. If Sitemap is exist by Yoest Plugin then no any new sitemap will generate.
