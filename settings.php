  ...
  <div class="container-fluid mt-3 jumbotron">
    ...
    <div class="row">
        ...
        <div class="rt-column col-10">
          ...
          if (isset($_POST['Submit']) && sanitize_text_field($_POST['noindex']) == 'noindex' && $_POST['Submit'] != '' && !isset($_POST['Reset']) ){
           ...
           <button type="button" class="notice-dismiss" data-bs-dismiss="alert" aria-label="Close"><span class="screen-reader-text">Dismiss this notice.</span></button>
             </div>' );
             $checked = 'checked';
            }
          ...
          else if (isset($_POST['Submit']) && $_POST['Submit'] != '' && sanitize_text_field($_POST['noindex']) != 'noindex'  && !isset($_POST['Reset']) ){
            ...
            _e( '<form action="'.$_SERVER['PHP_SELF'].'?page=on_page_seo" method="POST"> 
          ...
          <div class="sorm-switch">
            ...
            _e(  '<h5 class="mt-2 mb-2"><a href="'.get_site_url().'/robots.txt" target="_blank"> Open Robots.txt </a></h5>' );
            $sitemap = ABSPATH . sanitize_file_name('sitemap.xml');
            if(file_exists($sitemap)) {
              _e( '<h5 class="mt-2 mb-2"><a href="'.get_site_url().'/sitemap.xml" target="_blank">View sitemap.xml</a></h5>' );
            }
           ?>
